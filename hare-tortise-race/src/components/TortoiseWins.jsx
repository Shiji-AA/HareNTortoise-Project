...
function TortoiseWins() {
  ...
  return (
    ...
    >      
      ...
      transition={{ type: 'spring',stiffness:'500',duration: 10,ease: "easeInOut" }}
      src={flag2}
      alt="winnerflag"
      />
     {/* Center the first h1 element */}

<motion.h1
  className="absolute text-4xl font-bold text-center mb-20"
  initial={{ opacity: 0 }}
  animate={{ color: "#ff2994", opacity: 1, scale: [1, 1.2, 1], x: [-120, 0], y: [-15, 0] }}
...
<motion.h1
  ...
  initial={{ opacity: 0 }}
  animate={{ color: "#ff2994", opacity: 1, scale: [1, 1.2, 1], y: [-1, 0] }}
  transition={{ type: 'spring',duration: 2,delay:22, ease: "easeInOut" }}
>
